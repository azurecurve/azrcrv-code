...
### [Version 1.3.6](https://github.com/azurecurve/azrcrv-code/releases/tag/v1.3.6)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.3.5](https://github.com/azurecurve/azrcrv-code/releases/tag/v1.3.5)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.
 
### [Version 1.3.4](https://github.com/azurecurve/azrcrv-code/releases/tag/v1.3.4)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.3.3](https://github.com/azurecurve/azrcrv-code/releases/tag/v1.3.3)
 * Update readme files.
