 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_c')){
	function azrcrv_create_plugin_menu_c(){
		azrcrv_create_plugin_menu_table_c();
		azrcrv_populate_plugin_menu_table_c();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_c')){
	function azrcrv_populate_plugin_menu_table_c(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_c')){
	function azrcrv_create_plugin_menu_table_c(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
